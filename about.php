...
<!-- Start Hero Section -->
    ...
    <section class="cs_shape_wrap">
      ...
      <div class="cs_shape cs_shape_position_1"><img src="assets/svg/blog_shape1.svg" alt=""></div>
      <div class="container">
    ...
    <section class="cs_gray_bg_2">
      ...
      <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
          ...
          <h2 class="cs_fs_51 mb-0">Our Core Values</h2>
        </div>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="cs_iconbox cs_style_6 cs_shadow_1 text-center cs_white_bg">
              <div class="cs_iconbox_icon cs_accent_bg cs_mb_30 cs_center">
                <img src="assets/img/others/feature_icon_1.svg" alt="">
              </div>
              <h3 class="cs_iconbox_title cs_fs_28 cs_semibold cs_mb_24">Environmental Sustainability</h3>
              <p class="mb-0">At Yajayo, we are dedicated to protecting our planet by promoting responsible waste management, recycling, and circular economy practices that reduce pollution and preserve natural resources for future generations.</p>
            </div>
          </div>
          <div class="col-xl-4 col-md-6">
            <div class="cs_iconbox cs_style_6 cs_shadow_1 text-center cs_white_bg">
              <div class="cs_iconbox_icon cs_accent_bg cs_mb_30 cs_center">
                <img src="assets/img/others/feature_icon_2.svg" alt="">
              </div>
              <h3 class="cs_iconbox_title cs_fs_28 cs_semibold cs_mb_24">Empowerment</h3>
              <p class="mb-0">
                  We empower women and youth by providing training, employment, and entrepreneurship opportunities within the waste management value chain, helping them build sustainable livelihoods and drive community transformation.
              </p>
            </div>
          </div>
          <div class="col-xl-4 col-md-6">
            <div class="cs_iconbox cs_style_6 cs_shadow_1 text-center cs_white_bg">
              <div class="cs_iconbox_icon cs_accent_bg cs_mb_30 cs_center">
                <img src="assets/img/others/feature_icon_3.svg" alt="">
              </div>
              <h3 class="cs_iconbox_title cs_fs_28 cs_semibold cs_mb_24">Innovation</h3>
              <p class="mb-0">Through technology and innovation, we enhance efficiency, traceability, and data-driven decision-making in waste management — creating smarter, cleaner, and more sustainable systems for our partners and the planet.</p>
            </div>
          </div>
